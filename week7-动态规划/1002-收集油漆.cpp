...
nn 个人每人拿了一桶油漆进行房屋粉刷, 粉刷过后每个人桶里剩下的油漆体积为 r_ir 
i
​	
 , 假设每个人油漆桶的容积为 v_iv 
i
...
Input
输入的第一行为一个正整数 n\in [1,100]n∈[1,100], 表示油漆桶的数量.

第二行包含 nn 个正整数 r_1,\cdots ,r_nr 
1
​	
 ,⋯,r 
n
...
\forall i, r_i \leq v_i, r_i, v_i \in [1,100]∀i,r 
i
​	
 ≤v 
i
...
Output
输出单独一行, 包含两个正整数 x, yx,y, 用空格隔开, 分别表示最终用到的最少的桶的数量以及转移的油漆的总体积的最小值.
